...
namespace Pfizer.Domain.Models
{
    ...
    public class TerritorySalesConfigurationHistory : AbstractBaseModel
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [ColumnDescription("Primary key for sales configuration history table")]
        public int TerritorySalesConfigurationHistoryId { get; set; }
